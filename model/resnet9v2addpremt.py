...
# %%
class resnet9v2addpremt(nn.Module):
    def __init__(self,encoder=resnet9v2,planes=128,max_len=4,n_class=2):
        super(resnet9v2addpremt,self).__init__()
        self.planes=planes
        ...
        self.hand=nn.Sequential(
            ...
            nn.Conv1d(in_channels=128,out_channels = n_class, kernel_size = 4),
            nn.ReLU(inplace=True)
        )
        self.init_param()
