...
class mynet8(nn.Module):
    ...
    def __init__(self, layers=[1, 1, 1, 1], n_class=2, model_path=None):
        ...
        self.stack1 = self.make_stack(64, 2)
        self.stack2 = self.make_stack(128, 2, stride=1)
        self.se=SELayer(512)
...
# %%
class mynet8mtc1v2(nn.Module):
    def __init__(self,encoder=mynet8,planes=128,max_len=16,n_class=2):
        super(mynet8mtc1v2,self).__init__()
        self.planes=planes
