...
class mynetpre(nn.Module):
    """
    block: A sub module
    """

    def __init__(self,n_class=2):
        super(mynetpre, self).__init__()
        self.inplanes = 16
        ...
        self.se=SELayer(256)
        self.pos_embedding = nn.Parameter(torch.randn(1, 256, 36))
        self.token=Semantic_tokens(channel=256,token_len=32)
