...
class mynet3(nn.Module):
    ...
    def __init__(self,n_class=2):
        ...
        self.se=SELayer(128)
        self.ll=nn.Linear(36,64)
        self.lln=nn.LayerNorm(64)
        self.rl=nn.GELU()
        self.pos_embedding = nn.Parameter(torch.randn(1, 128, 64))
        # self.token=Semantic_tokens(channel=128,token_len=32)
        self.trf1=Transformer(64,1,8,64,128,0)
        self.trf2=Transformer(128,1,8,128,128,0)
        # self.trf2=Transformer(256,1,8,256,256,0)

        self.fn1=nn.Linear(128,4)
        self.ln=nn.LayerNorm(512)
        self.fn2=nn.Linear(512,n_class)
