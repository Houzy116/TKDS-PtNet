...
class resnet18(nn.Module):
    ...
    def __init__(self, layers=[2, 2, 2, 2], planes=144, model_path=None):
        ...
        self.fc = nn.Linear(512 * Bottleneck.expansion, 144*8)

        self.cla_fea = nn.Linear(512 * Bottleneck.expansion, 512 * Bottleneck.expansion)  #分类
        self.cla_term = nn.Linear(512 * Bottleneck.expansion, 144)  # 分类
...
# %%
class resnet18mtc1v5(nn.Module):
    def __init__(self,encoder=resnet18,planes=144,max_len=16,n_class=2):
        super(resnet18mtc1v5,self).__init__()
        self.planes=planes
