...
class resnet18(nn.Module):
    ...
    def __init__(self, layers=[2, 2, 2, 2], planes=144, model_path=None):
...
# %%
class resnet18mtc1v2(nn.Module):
    def __init__(self,encoder=resnet18,planes=144*4,max_len=16,n_class=2):
        super(resnet18mtc1v2,self).__init__()
        self.planes=planes
