...
class mynetpre12(nn.Module):
    """
    block: A sub module
    """

    def __init__(self,n_class=2):
        super(mynetpre12, self).__init__()
        self.inplanes = 16
        ...
        self.se=SELayer(64)
        self.pos_embedding = nn.Parameter(torch.randn(1, 64, 36))
        self.token=Semantic_tokens(channel=64,token_len=32)
