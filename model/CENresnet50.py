...
class CENresnet50(nn.Module):
    """
    block: A sub module
    """

    def __init__(self, layers=[3, 4, 6, 3], n_class=2, model_path=None):
        super(CENresnet50, self).__init__()
        self.inplanes = 64
        ...
        self.ln=nn.LayerNorm(512 * Bottleneck.expansion)
        self.cla_term = nn.Linear(512 * Bottleneck.expansion, 3)  # 分类
