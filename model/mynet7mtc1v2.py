...
class mynet7(nn.Module):
    ...
    def __init__(self, layers=[1, 1, 1, 1], n_class=2, model_path=None):
        ...
        self.stack3 = self.make_stack(256, layers[1], stride=1)
        self.se=SELayer(1024)
        self.fn=nn.Conv2d(1024, 128, kernel_size=1, stride=1,
                        bias=False)
...
# %%
class mynet7mtc1v2(nn.Module):
    def __init__(self,encoder=mynet7,planes=128,max_len=16,n_class=2):
        super(mynet7mtc1v2,self).__init__()
        self.planes=planes
