...
class mynet2pre2(nn.Module):
    """
    block: A sub module
    """

    def __init__(self,n_class=2):
        super(mynet2pre2, self).__init__()
        self.inplanes = 16
        # self.modelPath = model_path
        self.encoder=Encoder()
        self.pos_embedding = nn.Parameter(torch.randn(1, 128, 49))
        ...
        self.ln=nn.LayerNorm(196)
        self.fn2=nn.Linear(196,n_class)
