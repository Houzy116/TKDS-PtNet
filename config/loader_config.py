...
class DataConfig():
    ...
    def Udamagedv2(self,size,city,mode):
        self.info['train_dir']=f'/ssd/hk/Ukraine_samples/split_coordv2_v2/cities/{city}/train.pth'
        self.info['test_dir']=f'/ssd/hk/Ukraine_samples/split_coordv2_v2/cities/{city}/val.pth'
    def Udamagedv3crossval(self,size,city,mode):
        self.info['train_dir']=f'/ssd/hk/Ukraine_samples/split_coordv2_v3/cities/{city}/cross_val/{mode}/train.pth'
    ...
    def Udamagedv3(self,size,city,mode):
        self.info['train_dir']=f'/ssd/hk/Ukraine_samples/split_coordv2_v3/cities/{city}/train.pth'
        self.info['test_dir']=f'/ssd/hk/Ukraine_samples/split_coordv2_v3/cities/{city}/val.pth'
    def googledamagedv3rebuilingmulti10(self,size,city,mode):
        if city=='allcities':
            self.info['train_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti10/train.pth'
            self.info['test_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti10/val.pth'
        else:
            self.info['train_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti10/cities/{city}/train.pth'
            self.info['test_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti10/cities/{city}/val.pth'
    def googledamagedv3rebuilingmulti50(self,size,city,mode):
        if city=='allcities':
            self.info['train_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti50/train.pth'
            self.info['test_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti50/val.pth'
        else:
            self.info['train_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti50/cities/{city}/train.pth'
            self.info['test_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_rebuildingmulti50/cities/{city}/val.pth'
    
    def googledamagedv3rebuilingponly(self,size,city,mode):
        if city=='allcities':
            self.info['train_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_p_only/train.pth'
            self.info['test_dir']=f'/ssd/hk/Syria_samples/split_havedamaged_size{size}_all_v3_p_only/val.pth'

    def USAv3(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/USA_samples/split_v3/train.pth'
        self.info['test_dir']='/ssd/hk/USA_samples/split_v3/val.pth'

    def USAv4(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/USA_samples/split_v4/train.pth'
        self.info['test_dir']='/ssd/hk/USA_samples/split_v4/val.pth'

    def USAv2(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/USA_samples/split_v2/train.pth'
        self.info['test_dir']='/ssd/hk/USA_samples/split_v2/val.pth'

    def USASEGv2(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/USA_samples/split_seg_v2/train.pth'
        self.info['test_dir']='/ssd/hk/USA_samples/split_seg_v2/val.pth'

    def USASEGv3(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/USA_samples/split_seg_v3/train.pth'
        self.info['test_dir']='/ssd/hk/USA_samples/split_seg_v3/val.pth'

    def CENv3(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/cen_samples/split_v3/train.pth'
        self.info['test_dir']='/ssd/hk/cen_samples/split_v3/val.pth'
        
    def CENv2(self,size,city,mode):
        self.info['train_dir']='/ssd/hk/cen_samples/split_v2/train.pth'
        self.info['test_dir']='/ssd/hk/cen_samples/split_v2/val.pth'
